...
#define HOSTNAME "ESP8266-WeMos D1-" ///< Hostname. The setup function adds the Chip ID at the end.
...
const char* ssid = "FBI-Surveillance-Van-11";
const char* password = "X5cmk3b8!!!";
